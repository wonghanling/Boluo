...
开发英国首次验证后，再执行 `supabase_verification_uk_first.sql`。该脚本直接开放英国首次验证，并锁定英国长期首月和续租。

迁移只新增 `verification_*` 对象，不删除或重建现有表。当前仅美国短期和英国首次支持开放销售；英国长期首月和续租保持“暂未开放”。
...
6. 英国首次验证可开放小额测试；英国长期首月和续租继续锁定，正式接口未提供前不猜接口。
